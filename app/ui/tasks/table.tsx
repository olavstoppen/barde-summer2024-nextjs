                        ...
                        {filteredTasks?.map((tasks: task) => (
                            <div key={tasks.id + 'table'} className="mb-2 w-full rounded-md bg-white p-4">
                                ...
                                <div className="flex w-full items-center justify-between pt-4">
                                    <div>
                                        <p className="text-xl font-medium">{tasks.name}</p>
                                    </div>
                                </div>
                                <div className="flex w-full items-center justify-between pt-4">
                                    <div>
                                ...
                                (tasks: task) =>
                                    tasks.name.includes(query) && (
                                        ...
                                        >
                                            ...
                                            <td className="whitespace-nowrap px-3 py-3">{tasks.name}</td>
                                            <td className="whitespace-nowrap px-3 py-3">{tasks.type}</td>
                                            <td className="whitespace-nowrap px-3 py-3">{tasks.status}</td>
                                            <td className="whitespace-nowrap px-3 py-3">
                                                <div className="flex justify-end gap-3">
                                                    ...
                                                    >
                                                        ...
                                                        <span className="hidden md:block ml-3">Se info</span>
                                                    </Link>
                                                </div>
                                            </td>
                                        </tr>
